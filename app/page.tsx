    ...
    <main className="min-h-screen bg-background text-foreground">
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-8 items-center">
            ...
            <div className="flex flex-col gap-8">
              ...
              <button
                ...
                className="group w-fit cursor-pointer flex items-center gap-3 bg-accent hover:bg-accent/90 text-accent-foreground px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300 hover:shadow-lg hover:shadow-accent/30 active:scale-95 animate-bounce-gentle"
              >
              ...
              <div className="flex items-center gap-2 pt-4">
                ...
                <span className="text-sm text-muted-foreground">
                  Trusted by hungry OAU students
                </span>
              </div>
            </div>
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="rounded-3xl bg-white/10 backdrop-blur p-8 border border-white/20">
              ...
              <div>
                <p className="font-bold">Qanit</p>
                <p className="text-sm text-white/60">
                  400-level, Surveying & Geo Informatics
                </p>
              </div>
            </div>
            ...
            <div className="rounded-3xl bg-white/10 backdrop-blur p-8 border border-white/20">
              ...
              <div>
                ...
                <p className="text-sm text-white/60">500-level, Engineering</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <footer className="px-4 py-12 sm:px-6 lg:px-8 bg-muted/40 border-t border-border">
        <div className="mx-auto max-w-6xl text-center text-muted-foreground">
          <p>
            © 2026 OAU ChowFinder. Built by ElvistheSaint, A hungry student.
          </p>
        </div>
      </footer>
    </main>
